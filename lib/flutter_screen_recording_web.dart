...
import 'package:new_flutter_screen_recording/platform_interface/flutter_screen_recording_platform_interface.dart';
...
class WebFlutterScreenRecording extends FlutterScreenRecordingPlatform {
  ...
  Future<bool> _record(String name, bool recordVideo, bool recordAudio) async {
    try {
      ...
      mediaRecorder =  MediaRecorder(stream!, {'mimeType': mimeType});
